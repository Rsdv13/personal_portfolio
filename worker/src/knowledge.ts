...
row-level security) the business relies on. More recently, pushing the team into AI territory:
prototyping a multi-agent orchestration proof of concept on Azure AI Foundry using the
Microsoft Agent Framework (MAF), and building a monitoring framework for a Microsoft Fabric
